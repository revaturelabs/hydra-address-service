...
public class BuildingController {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully created a building"),
	...
	public Object createBuilding(@RequestBody BuildingDTO in) {
		...
		int location = in.getLocation(); // building's location id. This is where it is was breaking - said the location
											// id is 0
		...
		out = buildingService.saveItem(out);// I need to see this: active is being set to null in the db. Is it because
											// it should be 1 in the db instead of true? idk
		if (out == null) {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieved a building"),
			@ApiResponse(code = 400, message = "Bad Request, BuildingDTO"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully updated building"),
			@ApiResponse(code = 400, message = "Bad Request, BuildingDTO"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully delete a building"),
			@ApiResponse(code = 400, message = "Bad Request, BuildingDTO"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieve all buildings"),
			@ApiResponse(code = 400, message = "Bad Request, BuildingDTO"),
