...
public class LocationController {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully created Location information"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieved Location information"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully updated Location information"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully deleted Location"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieved all Locations"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
