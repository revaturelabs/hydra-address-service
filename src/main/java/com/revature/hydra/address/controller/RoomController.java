...
public class RoomController {
	...
	// CREATE
	// creating new room object from information passed from room data transfer
	// object
	// @PreAuthorize("hasPermission('', 'manager')")
	@RequestMapping(method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value = "Create a Room", response = ResponseEntity.class)
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully created Room information"),
	...
	public Object createRoom(@RequestBody RoomDTO in) {
		...
		if (out == null) {
			return new ResponseEntity<ResponseErrorDTO>(new ResponseErrorDTO("Room failed to save."),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieved Room information"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	public Object retrieveRoom(@PathVariable("id") int ID) {
		...
		if (out == null) {
			return new ResponseEntity<ResponseErrorDTO>(new ResponseErrorDTO("No room found of ID " + ID + "."),
	...
	// UPDATE
	// updating an existing room object with information passed from room data
	// transfer object
	// @PreAuthorize("hasPermission('', 'manager')")
	@RequestMapping(method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiOperation(value = "Update a Room", response = ResponseEntity.class)
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully updated Room information"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	public Object updateRoom(@RequestBody RoomDTO in) {
		...
		if (out == null) {
			return new ResponseEntity<ResponseErrorDTO>(new ResponseErrorDTO("Room failed to update."),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully deleted Room"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Successfully retrieved all Rooms"),
			@ApiResponse(code = 400, message = "Bad Request, the information recieved maybe invalid"),
	...
	public Object retrieveAllRooms() {
		...
		if (all == null) {
			return new ResponseEntity<ResponseErrorDTO>(new ResponseErrorDTO("Fetching all rooms failed."),
					HttpStatus.NOT_FOUND);
		} else if (all.isEmpty()) {
			return new ResponseEntity<ResponseErrorDTO>(new ResponseErrorDTO("No rooms available."),
					HttpStatus.NOT_FOUND);
		} else {
